    ...
    <div className="min-h-screen bg-slate-100">
      <div className="mt-16 p-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <StatCard title="Pending Requests" value="12" icon={<FaClock />} />
          <StatCard title="Approved Requests" value="45" icon={<FaCheckCircle />} />
          <StatCard title="Rejected Requests" value="5" icon={<FaTimesCircle />} />
          <StatCard title="Total Requests" value="62" icon={<FaCheckCircle />} />
        </div>
